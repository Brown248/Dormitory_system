        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3">
          ...
          <div>
            ...
            >
              ...
              <option value={TransactionType.INCOME}>📈 รายรับเท่านั้น</option>
              <option value={TransactionType.EXPENSE}>📉 รายจ่ายเท่านั้น</option>
            </select>
          </div>
          ...
          <div>
            ...
            >
              ...
              <option value="general">⚙️ ทั่วไป (ไม่มีสังกัด)</option>
            </select>
          </div>
          ...
          <div>
            <select
              ...
              className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition outline-none text-xs font-black cursor-pointer"
            >
              <option value="newest">📅 ล่าสุด ไป นานสุด</option>
              <option value="oldest">📅 นานสุด ไป ล่าสุด</option>
              <option value="highest">💰 ยอดเงิน สูง ไป ต่ำ</option>
              <option value="lowest">💰 ยอดเงิน ต่ำ ไป สูง</option>
            </select>
          </div>
        </div>

        {/* Dynamic statistics based on search filters */}
        {(filterType !== "all" || filterUnit !== "all" || searchTerm) && (
          <div className="flex flex-wrap gap-4 text-xs font-bold bg-slate-50 p-3 rounded-xl border border-slate-100">
            ...
            <button 
              onClick={() => { setFilterType("all"); setFilterUnit("all"); setSearchTerm(""); setSortBy("newest"); }}
